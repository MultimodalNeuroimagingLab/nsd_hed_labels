...
def generate_markdown_content():
    ...
    mdFile.new_line('**All links to COCO images should be working.**')
    mdFile.new_line('note: actual NSD images may be a cropped version of the COCO image. The cropped version is the one displayed here and on GitHub.')
